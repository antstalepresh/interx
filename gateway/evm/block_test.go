...
func (suite *BlockQueryTestSuite) TestQueryEVMBlockByHeight() {
	...
	common.GetLogger().Info("byteData", byteData)
	...
	suite.Require().EqualValues(result.Height, suite.height)
}
